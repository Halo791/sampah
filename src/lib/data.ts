...
export const orders: Order[] = [
  {
    ...
    items: [
      { productId: 'prod_001', productName: 'HDPE Pellets', quantity: 500, price: 1.5 },
      { productId: 'prod_002', productName: 'PET Flakes', quantity: 1000, price: 1.2 },
    ],
    total: 500 * 1.5 + 1000 * 1.2,
    status: 'Delivered',
  ...
  },
  {
    ...
    items: [{ productId: 'prod_002', productName: 'PET Flakes', quantity: 2000, price: 1.2 }],
    total: 2000 * 1.2,
    status: 'Shipped',
  ...
  },
  {
    ...
    items: [{ productId: 'prod_003', productName: 'LDPE Film', quantity: 1500, price: 1.0 }],
    total: 1500 * 1.0,
    status: 'Processing',
  ...
  },
  {
    ...
    items: [{ productId: 'prod_004', productName: 'PP Granules', quantity: 800, price: 1.3 }],
    total: 800 * 1.3,
    status: 'Pending',
